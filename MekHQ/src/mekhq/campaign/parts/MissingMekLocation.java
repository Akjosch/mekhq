...
public class MissingMekLocation extends MissingPart {
    ...
    public boolean isAcceptableReplacement(Part part, boolean refit) {
        ...
        if(part instanceof MekLocation) {
            ...
            return mekLoc.get(Installable.class).getMainLocation() == loc
    ...
    public Part getNewPart() {
       /* int cockpitType = -1;
        ...
        Part nPart = new MekLocation(loc, get(Installable.class).getUnitTonnage(), structureType, tsm, forQuad, sensors, lifeSupport, campaign);
        return nPart;
    }
    ...
    public void updateConditionFromPart() {
        ...
        if(null != entity) {
            int loc = get(Installable.class).getMainLocation();
            entity.setInternal(IArmorState.ARMOR_DESTROYED, loc);
        }
    }
